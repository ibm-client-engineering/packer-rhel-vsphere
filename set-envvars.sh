...
echo -e '\n> Set the RedHat Subscription Manager activation details.'
read -r -p "Enter the organization ID for the account: " rhsm_org
read -r -s -p "Enter the key for the account: " rhsm_key
echo # Needed for line break.
...
[yY][eE][sS] | [yY])
	...
	*) ;;
	...
	# RedHat Subscription Manager Activation
	echo -e '\nRedHat Subscription Manager Activation'
	echo - PKR_VAR_rhsm_org: "$PKR_VAR_rhsm_org"
	echo - PKR_VAR_rhsm_key: "$PKR_VAR_rhsm_key"
