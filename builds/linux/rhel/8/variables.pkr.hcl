...
variable "rhsm_password" {
  ...
  validation {
    ...
    # The split() function creates a list of characters.
    # The contains() function then checks if that list contains a single quote.
    condition     = !contains(split("", var.rhsm_password), "'")
    error_message = "The 'rhsm_password' variable cannot contain a single quote ('). This is to prevent issues with shell commands."
  }
}
